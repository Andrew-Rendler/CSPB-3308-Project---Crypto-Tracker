...
class CryptoDataTestCase(unittest.TestCase):
    def test_init(self):
        ...
        self.assertGreater(
            len(cryptodata.dataList), 0, "dataList should have length greater than 0"
        )
        self.assertGreater(
            cryptodata.currentPrice, 0, "currentPrice should equal BTC price"
        )
        self.assertGreater(
            cryptodata.previousClose,
            0,
            "previousClose should equal BTC price from yesterday",
        )
        self.assertGreater(
            len(cryptodata.volumeList),
            0,
            "volumeList should have length greater than 0",
        )
    ...
    def test_percentChange(self):
        ...
        self.assertNotEqual(
            percent.match(cryptodata.percentChange()),
            None,
    ...
    def test_dollarChange(self):
        ...
        self.assertNotEqual(
            dollar.match(cryptodata.dollarChange()),
            None,
            "Return value formatted incorrectly",
        )
    ...
    def test_marketCap(self):
        ...
        self.assertNotEqual(
            dollar.match(cryptodata.marketCap()),
            None,
            "Return value formatted incorrectly",
        )
    ...
    def test_averageVolume(self):
        ...
        dollar = re.compile(r"^[0-9]*[\.]{1}[0-9]{2}$")
        self.assertNotEqual(
            dollar.match(cryptodata.averageVolume()),
            None,
            "Return value formatted incorrectly",
        )
